...
We can read more about horses in Canada from this research [@horses]
...
```{r plot province, fig.width=5, fig.height=4, fig.cap="Figure 2. Number of horse for province of focus", out.width="50%"}
